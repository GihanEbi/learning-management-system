    ...
    <>
      ...
      <main className="flex-1 flex flex-col items-center py-10 px-4">
        <div className="max-w-[1000px] w-full bg-white dark:bg-[#121121] rounded-xl shadow-sm border border-slate-200 dark:border-slate-800 p-8">
          ...
          <div className="grid grid-cols-4 gap-x-2 px-4 mb-10">
            {/* Step 1: Completed */}
                ...
                <button
                  ...
                  className={`flex flex-col gap-3 rounded-xl p-5 text-left transition-all border-2 ${
                    userData.learningStyle === style.label
                      ...
                      : "border-slate-100 dark:border-slate-800 bg-slate-50 dark:bg-slate-900/50 hover:border-[#5048e5]/50"
                  }`}
                >
                  <div className="flex justify-between w-full">
                    <span
                      className={`material-symbols-outlined text-3xl ${userData.learningStyle === style.label ? "text-[#5048e5]" : "text-slate-400"}`}
                    >
                      {style.icon}
                    </span>
                    {userData.learningStyle === style.label && (
